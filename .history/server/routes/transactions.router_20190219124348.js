...
router.get('/customer/balance/:customer_id', function(req, res) {
    ...
    Transaction.getInvoiceBalance(customer_id, function (err, callback) {  // <<=== pass callback here
        console.log("in the aggregation: ", customer_id); // returns challengeId
    ...
    // isSolved(customer_id, function(err, results) {
    //     if (err) {
